...
#   make train-all MODELS=foundation_model                            # Run only foundation_model configs
#   make train-all TASKS=sentence_onset_task                          # Run only sentence_onset_task configs
#   make train-all MODELS=foundation_model,neural_conv_decoder TASKS=word_embedding_decoding_task
