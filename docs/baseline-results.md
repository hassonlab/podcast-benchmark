...
**Config:** `configs/baselines/content_noncontent_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/word_embedding_decoding_task/neural_conv_decoder/arbitrary_supersubject.yml`
...
**Config:** `configs/baselines/word_embedding_decoding_task/neural_conv_decoder/glove_supersubject.yml`
...
**Config:** `configs/baselines/word_embedding_decoding_task/neural_conv_decoder/gpt2_supersubject.yml`
...
**Config:** `configs/baselines/whisper_embedding_decoding_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/gpt_surprise_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/gpt_surprise_multiclass_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/pos_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/sentence_onset_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/iu_boundary_task/neural_conv_decoder/supersubject.yml`
...
**Config:** `configs/baselines/llm_decoding_task/neural_conv_decoder/two_stage_multi_supersubject.yml`
