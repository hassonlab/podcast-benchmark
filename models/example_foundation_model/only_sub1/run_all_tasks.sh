#!/bin/bash
# Run all finetuning tasks for example_foundation_model on subject 1 only
#
...
LOG_FILE="$LOG_DIR/example_foundation_model_sub1_${TIMESTAMP}.log"
...
run_task() {
    ...
    # Run the evaluation
    if python main.py --config "$config_path"" \
...
# Main execution
log "========================================="
log "Example Foundation Model - Subject 1 Only"
log "Started at: $(date)"
