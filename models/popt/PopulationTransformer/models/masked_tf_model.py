...
class MaskedTFModel(BaseModel):
    ...
    def forward(self, input_specs, src_key_mask, intermediate_rep=False, rep_from_layer=-1, positions=None):
        input_specs, pos_enc = self.input_encoding(input_specs, positions=positions)
