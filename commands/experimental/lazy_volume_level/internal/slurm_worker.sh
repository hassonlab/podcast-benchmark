...
OUTPUT_DIR="${PROJECT_ROOT}/results/experimental/lazy_volume_level/${MODEL}/${TASK}/${VARIANT}"
CHECKPOINT_DIR="${PROJECT_ROOT}/checkpoints/experimental/lazy_volume_level/${MODEL}/${TASK}/${VARIANT}"
TENSORBOARD_DIR="${PROJECT_ROOT}/event_logs/experimental/lazy_volume_level/${MODEL}/${TASK}/${VARIANT}"
...
"$PYTHON_BIN" experimental/lazy_volume_level/main.py \
    --config "$CONFIG_PATH" \
