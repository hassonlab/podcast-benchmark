...
# Every task's supersubject variant; uncomment the ones to run.
baseline_configs=(
    ...
    # "configs/baselines/word_embedding_decoding_task/neural_conv_decoder/arbitrary_supersubject.yml"
    ...
    # "configs/baselines/llm_decoding_task/neural_conv_decoder/two_stage_multi_supersubject.yml"
)
